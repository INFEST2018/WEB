...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
            ...
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/files/large/',
            'upload_url' => $this->get_full_url().'/files/large/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
            ...
            */
            ...
            'image_versions' => array(
                ...
                'thumbnail' => array(
                    ...
                    //'crop' => true,
                    'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/files/thumb/',
                    'max_width' => 120,
                    'max_height' => 120
                )
            )
