                ...
                <div class="section full-width flv_sections_16">
                    <div class="section_wrapper clearfix">
                        ...
                        <div class="deskripsi">
                            ...
                            <h3>Tahap Penyisihan (Online Selection)</h3>
                            <img style="padding: 0px 0 20px 0; height:3px; width:450px;" src="<?php echo base_url() ?>asset/theme/custom-image/icon/line.png">
                            <ol class="list-content">
                                <li>Tahap penyisihan merupakan tahap penyeleksian online pada situs Informatic Festival.</li>
                                <li>Peserta akan menyelesaikan tiap tiap permasalahan dengan membangun program langsung pada website tersebut.</li>
                                <li>Terdapat 8-10 soal yang harus di selesaikan peserta dengan durasi waktu 4 jam terhitung sejak peserta mengkonfirmasi akan memulai mengerjakan soal.</li>
