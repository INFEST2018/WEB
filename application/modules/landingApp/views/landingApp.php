    ...
    <div id="Wrapper">
        ...
        <div class="sponsor">
            ...
            <ul  class="line-sponsor">
                <li>
                    <img  class="img-sponsor"src="<?php echo base_url() ?>asset/theme/custom-image/sponsor/Artboard_1.png">
                </li>
                <li>
                    <img class="img-sponsor"src="<?php echo base_url() ?>asset/theme/custom-image/sponsor/Artboard_2.png">
                </li>
                <li>
                    <img class="img-sponsor"src="<?php echo base_url() ?>asset/theme/custom-image/sponsor/Artboard_3.png">
                </li>
                <li>
                    <img class="img-sponsor"src="<?php echo base_url() ?>asset/theme/custom-image/sponsor/Artboard_4.png">
                </li>
                <li>
                    <img class="img-sponsor"src="<?php echo base_url() ?>asset/theme/custom-image/sponsor/Artboard_5.png">
                </li>
                <li>
                    <img class="img-sponsor"src="<?php echo base_url() ?>asset/theme/custom-image/sponsor/Artboard_6.png">
                </li>
                <li>
                    <img class="img-sponsor"src="<?php echo base_url() ?>asset/theme/custom-image/sponsor/Artboard_7.png">
                </li>
                <li>
                    <img class="img-sponsor"src="<?php echo base_url() ?>asset/theme/custom-image/sponsor/Artboard_8.png">
                </li>
                <li>
                    <img class="img-sponsor"src="<?php echo base_url() ?>asset/theme/custom-image/sponsor/Artboard_9.png">
                </li>
                <li>
